...
```ShellSession
git clone https://github.com/4k4xs4pH1r3/bbh.git /usr/share/wordlists && cd /usr/share/wordlists/wordlists && mv *.* /usr/share/wordlists && mv dirb disbuster fern-wifi wfuzz /usr/share/wordlists && rm -r /usr/share/wordlists/wordlists
```
